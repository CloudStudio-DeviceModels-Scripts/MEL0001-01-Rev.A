...
# Configuration Script – MEL0001-01 - Rev. A

This **Configuration** script is designed for the **MEL0001-01** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – MEL0001-01 Rev. A

Este script de **Configuration** está diseñado para el modelo **MEL0001-01** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
